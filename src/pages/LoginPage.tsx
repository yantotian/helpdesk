    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex flex-col justify-between w-1/2 p-12 border-r border-border relative overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-primary mono text-sm tracking-widest">HELPDESK.SYS</span>
        </div>
        ...
        <div>
          ...
          <h1 className="mono text-4xl font-bold text-foreground leading-tight mb-4">
            IT HELPDESK<br />
            <span className="text-primary">TICKETING</span><br />
            SYSTEM
          </h1>
          <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
            Enterprise-grade incident management. Full lifecycle tracking from ticket creation to closure.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-2 mb-8 md:hidden">
            ...
            <span className="text-primary mono text-xs tracking-widest">HELPDESK.SYS</span>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {mode === 'register' && (
                <div className="space-y-1">
                  <Label className="mono text-xs text-muted-foreground">FULL NAME</Label>
                  <Input
              ...
              <div className="space-y-1">
                <Label className="mono text-xs text-muted-foreground">USERNAME</Label>
                <Input
                  required
                  value={form.username}
              ...
              <div className="space-y-1">
                <Label className="mono text-xs text-muted-foreground">PASSWORD</Label>
              ...
              {mode === 'register' && (
                <>
                  <div className="space-y-1">
                    <Label className="mono text-xs text-muted-foreground">ROLE</Label>
                    <div className="w-full bg-input border border-border px-3 py-2 mono text-sm text-muted-foreground select-none">
                      Requester
                    </div>
                  </div>
                  <div className="space-y-1">
                    <Label className="mono text-xs text-muted-foreground">OFFICE (optional)</Label>
                    <Input
                      value={form.office}
                  ...
                  <div className="space-y-1">
                    <Label className="mono text-xs text-muted-foreground">CONTACT (optional)</Label>
                    <Input
                      value={form.contact}
